...
const texts = ['All', 'Korea', 'Japan', 'China']
...
let menus = document.querySelectorAll('.menuBtn');

menus.forEach((e) => {
  e.addEventListener('click', function() {
    if(e.innerHTML !== 'All') {
      const filteredItem = menu.filter((item) => item.category === e.innerHTML);
      getItems(filteredItem);
    } else {
      getItems(menu);
    }
  });
